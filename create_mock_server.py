"""
Script pour créer le fichier mock_analytics_server.py
"""
...
# Créer le fichier
with open('mock_analytics_server.py', 'w', encoding='utf-8') as f:
    f.write(mock_server_content)

print("✅ Fichier mock_analytics_server.py créé avec succès!")
print("\n📋 Prochaines étapes :")
print("1. Installer Flask : pip install flask numpy")
print("2. Arrêter votre serveur actuel (Ctrl+C)")
print("3. Lancer : python mock_analytics_server.py")
print("4. Dans un nouveau terminal : python tests\\quick_test_analytics.py")