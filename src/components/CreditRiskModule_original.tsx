...
Copy-Item src/components/CreditRiskModule.tsx src/components/CreditRiskModule_original.tsx
                ...
                <div className="p-5">
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full font-medium py-3 px-4 rounded-md transition-all flex items-center justify-center mt-6"
                      style={{
...
"@ | Out-File -FilePath src/components/CreditRiskModule.tsx -Encoding utf8