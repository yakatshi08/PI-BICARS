...
import { 
  ...
  Upload, Calculator // Icône ajoutée
} from 'lucide-react';
    ...
    <div className={`min-h-screen ${darkMode ? 'bg-slate-900' : 'bg-gray-50'}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          {/* Ajout de la carte Actuarial Analytics */}
          <div 
            onClick={() => navigate('/actuarial')}
            className="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl p-6 cursor-pointer hover:shadow-xl transition-all transform hover:scale-105"
          >
            <Calculator className="h-8 w-8 text-white mb-4" />
            <h3 className="text-xl font-semibold text-white mb-2">Actuarial Analytics</h3>
            <p className="text-indigo-100">Modèles actuariels & projections</p>
          </div>
          ...
          {/* Nouveau bouton Modèles de Provisionnement */}
          <div
            onClick={() => navigate('/actuarial/provisioning')}
            className="w-full p-6 bg-gradient-to-br from-purple-600 to-indigo-600 rounded-xl hover:shadow-xl transition-all transform hover:scale-105 text-left cursor-pointer"
          >
...
};  // Fin de la fonction ActuarialDashboard
